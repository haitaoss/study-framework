package cn.haitaoss.multidatasource.aop;

import cn.haitaoss.multidatasource.annotation.DS;
...
public class DynamicDatasourceAspect {
     ...
     */
    @Pointcut(value = "@annotation(cn.haitaoss.multidatasource.annotation.DS) || execution(* cn.haitaoss.multidatasource.service..*(..))")
